 ...
 * @author Rune Barrett
 */
public class NormalSpellExplosionControl extends AbstractControl {
    ...
    public NormalSpellExplosionControl(GamePlayAppState GPAState, BulletAppState BAState, AssetManager assetManager, Vector3f pos, Node ballNode, Geometry ballGeo) {
